...
% \fancyfoot[C,C]{--~\thepage~--}
% THU Version
% \fancyhead[RO]{\CJKfamily{song}\wuhao\leftmark}
% \fancyhead[CE]{\CJKfamily{song}\wuhao\leftmark}
% \fancyfoot[C,C]{\wuhao--~\thepage~--}
 % PKU Version
 \fancyhead[RO]{\CJKfamily{song}\wuhao\leftmark}
 \fancyhead[LE]{\CJKfamily{song}\wuhao\rightmark}
...
\renewcommand{\captionfont}{\xiaosi}
...
\def\copyright{
    ...
    \hspace{2em}任何收存和保管本论文各种版本的单位和个人，
    未经本论文作者同意，不得将本论文转借他人，亦不得随意复制、抄录、拍照或以任何方式传播。
...
\def\makecover{
    ...
    %
    \begin{figure}[htb!]
    \centerline{\epsfig{file=logo.eps,width=0.7\columnwidth,clip=}}
    \end{figure}


    \parbox[t][3cm][c]{\textwidth}{\xiaochu
    \begin{center} {
    \song \bf \@cdegree研究生学位论文}\end{center} }

    \begin{center}{\xiaoer {\song 题目：\underline{\@ctitle}}}\end{center}
    ...
    ~ & 姓\hfill\hfill名 & ：&\@cauthor\\
    ~ & 学\hfill\hfill号 & ：& \@cnumber\\
    ~ & 院\hfill\hfill系 & ：& \@caffil\\
    ~ & 专\hfill\hfill业 & ：& \@csubject\\
    ~ & 研~究~方~向 & ：& \@csubsub\\
    \hspace{2cm} & 导~师~姓~名 & ：& \@csupervisor
    \end{tabular} \end{center} } }

    \parbox[t][3cm][b]{\textwidth}{
    \begin{center} {\xiaoer \kai \@cdate} \end{center} }
...
%    \thispagestyle{empty}
    ...
    %\parbox[t][3cm][c]{\textwidth}{\erhao
    %\begin{center} {\textbf{\textsf{\@etitle}}}\end{center} }

    %\parbox[t][2cm][t]{\textwidth}{
    %\begin{center}  \end{center} }

    %\parbox[t][3cm][c]{\textwidth}{\begin{center} {\sanhao \textbf{By} } \end{center}
    %\begin{center} {\sanhao \textbf{\@eauthor} } \end{center}
    %{\xiaosan
    %\begin{center}
    %\begin{tabular}{rl}
    ...
    %\begin{center} {\sanhao A Dissertation Presented
    %to the\\FACULTY OF THE GRADUATE SCHOOL\\PEKING UNIVERSITY } \end{center} }

    %\parbox[t][5cm][c]{\textwidth}{
    %\begin{center} {\sanhao In Partial Fulfillment of the
    %Requirement\\for the Degree of\\\textbf{\textsf{\@edegree}\\(\@esubject)}} \end{center}
    %}
...
\def\makeabstract{
    ...
    \newpage
    %\chapter*{}
    \addcontentsline{toc}{chapter}{\hei ABSTRACT（英文摘要）}
    \markboth{英~文~摘~要}{英~文~摘~要}
    \begin{center} {\sanhao \textbf{\textsf{\@etitle}}\\
    \sihao \@eauthor(\@esubject)\\
    Directed by \@esupervisor}\end{center}
...
\long\def\statement{
    ...
    %\markboth{原创性声明和使用授权说明}{原创性声明和使用授权说明}
    %\addcontentsline{toc}{chapter}{\hei原创性声明和使用授权说明}

    \begin{center}
    \parbox[t][2cm][c]{\textwidth}{ {\sanhao \song \centerline {\textbf{北京大学学位论文原创性声明和使用授权说明}}}}

    \parbox[t][2cm][c]{\textwidth}{ {\sihao \song \centerline {\textbf{原创性声明}}}}

    \parbox[t][3cm][c]{\textwidth}{ {\song \xiaosi
    \hspace{2em}本人郑重声明： 所呈交的学位论文，是本人在导师的指导
    下，独立进行研究工作所取得的成果。除文中已经注明引用的内容外，
    本论文不含任何其他个人或集体已经发表或撰写过的作品或成果。对本
    文的研究做出重要贡献的个人和集体，均已在文中以明确方式标明。本
    声明的法律结果由本人承担。}}

    \parbox[t][1cm][b]{\textwidth}{{\song \xiaosi \hspace{5cm}
    论文作者签名：\hfill 日期：~~~~~~年~~~~月~~~~日}}

    \end{center}

    \begin{center}
    \parbox[t][4cm][c]{\textwidth}{ {\sihao \song \centerline
    {\textbf{学位论文使用授权说明}} } }

    \parbox[t][3cm][c]{\textwidth}{\xiaosi
    \hspace{2em}本人完全了解北京大学关于收集、保存、使用学位论文的规定，即：\\
\hspace*{2em} 按照学校要求提交学位论文的印刷本和电子版本；\\
\hspace*{2em} 学校有权保存学位论文的印刷本和电子版，并提供目录检索与阅览服务；\\
\hspace*{2em} 学校可以采用影印、缩印、数字化或其它复制手段保存论文；\\
\hspace*{2em}
在不以赢利为目的的前提下，学校可以公布论文的部分或全部内容。 }

    \parbox[t][3cm][c]{\textwidth}{\banxiaosi
    \hspace{2em}\textbf{（保密的论文在解密后应遵守此规定）} }

    \parbox[t][2cm][c]{\textwidth}{\song \xiaosi \hspace{4cm}
    论文作者签名：\hfill 导师签名：\hfill \hspace{1cm}
    \\ \hspace*{6cm} 日期：~~~~~~~~年~~~~~月~~~~~日\hspace{1cm} }
